...
//https://www.surfertoday.com/windsurfing/how-to-read-wind-direction
        ...
        document.querySelectorAll('.card__desc')[1].innerHTML = `Feels like: ${Math.ceil(data.main.feels_like)}&deg;C`;
        document.querySelectorAll('.card__desc')[2].innerHTML = `Wind: 
            <svg style="transform: rotate(${wind+180}deg); height: 8pt;" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve">
                <g fill="#48484a">
        ...
        document.querySelectorAll('.card__desc')[3].innerHTML = `Humidity: ${data.main.humidity}%`;
